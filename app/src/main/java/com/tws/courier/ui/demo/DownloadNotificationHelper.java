...
import com.app.monrotv.ui.demo.NotifyDownloadActionsReceiver;
...
public final class DownloadNotificationHelper {
    ...
    private Notification buildNotification(
        ...
        if (titleStringId == com.google.android.exoplayer2.ui.R.string.exo_download_downloading) {
            Intent snoozeIntent = new Intent(context, NotifyDownloadActionsReceiver.class);
            snoozeIntent.setAction(NotifyDownloadActionsReceiver.ACTION_CANCEL_DOWNLOADS);
            PendingIntent snoozePendingIntent = PendingIntent.getBroadcast(context, 0, snoozeIntent, 0);
            notificationBuilder.addAction(com.google.android.exoplayer2.ui.R.drawable.exo_icon_stop, "Cancel", snoozePendingIntent);
        }
